...
<div class="page">
  ...
  <div class="header">
    <div>
      ...
      <div class="header-sub">Seguimiento de cotizaciones</div>
    </div>
...
export function previewCotizacionesReportPdf(payload) {
  return buildHtml({ ...payload, autoPrint: false });
}

export function printCotizacionesReportPdf(payload) {
